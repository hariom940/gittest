        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-tasks"></i> Add Store</h3>
                    <a href="{{ url('/admin/stores') }}" class="btn btn-warning pull-right">Cancel</a>
                </div>
                <!-- /.box-header -->

                <form class="form-horizontal" role="form" method="POST" id="admin_login" action="{{ url('/admin/store/add') }}" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                            {{ csrf_field() }}
                            <!-- text input -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="checkbox" name="featured_store" class="flat-red" value="1" {{ old('featured_store') == 1 ? 'checked="checked"' : '' }}>{{ "&nbsp; Enable as a featured store " }}
                                    </div>
                                </div>
