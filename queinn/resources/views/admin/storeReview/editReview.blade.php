            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right">
                        <a href="{{ url('/admin/stores/reviews') }}" class="btn btn-warning">Back</a>
                    </div>
                </div>

                <!-- /.box-header -->

                <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/stores/review/edit/').'/'.$reviewData->id}}">
                    <div class="box-body">
                    {{ csrf_field() }}
                    <!-- text input -->
