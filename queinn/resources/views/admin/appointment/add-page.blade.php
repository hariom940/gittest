        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <a href="{{ url('/admin/appointment') }}" class="btn btn-warning pull-right">Cancel</a>
            </div>
            <!-- /.box-header -->
            
              <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/appointment/add')}}">
              <div class="box-body">
              {{ csrf_field() }}
                <!-- text input -->            
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="date" name="date" value="" autocomplete="off">
                  </div>  
                 </div>
