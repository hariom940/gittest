...
--
-- Host: localhost
-- Generation Time: Jul 25, 2020 at 08:29 AM
...
INSERT INTO `admin_users` (`id`, `name`, `email`, `role`, `featured_image`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Queinn', 'gvikas@deaninfotech.com', 1, 'assets/uploads/adminuser/admin.png', '$2y$10$FHdZLzcw25WlBInjT8H.I.7HwNThV/F/3jPVbqsUPn2yXhVZgnd8W', 'Uqz5nghpMOJtumWzelhRgLOiQW8CYOhARABzk1po7aWo5xQ08NiE9L6SK5BL', NULL, '2020-07-22 09:44:53'),
(10, 'Bigfrog', 'info@bigfrog.io', 0, NULL, '$2y$10$Lrj85K2BTKXjTRqOpm1O8.g07AaonXYqVBlNUrV1BaCvPK7uj1Ani', NULL, '2019-10-21 23:00:34', '2019-10-21 23:00:34');
...
CREATE TABLE `blogs` (
  ...
  `page_title` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `page_keyword` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `page_description` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `allow_comments` int(11) DEFAULT 0 COMMENT '1=> Show, 0=>hide',
  `categories` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `tags` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `related_post` int(11) NOT NULL DEFAULT 0 COMMENT '1 => Enable, 0 => Disable',
  `featured_post` int(11) NOT NULL DEFAULT 0 COMMENT '1 => Enable, 0 => Disable',
  `visibility` int(11) NOT NULL DEFAULT 1 COMMENT '1 => Enable, 2=> Disable',
...
CREATE TABLE `blog_categories` (
  ...
  `visible_status` int(11) NOT NULL DEFAULT 1 COMMENT '1=> Enable, 2=>Disable ',
...
CREATE TABLE `blog_comments` (
  ...
  `status` int(11) NOT NULL DEFAULT 1 COMMENT '1 => Enable, 2 => Disable',
  `created_at` datetime NOT NULL,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `businesses` (
  ...
  `is_email_verified` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `business_name` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `business_type` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `business_days` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `business_from_hours` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `business_to_hours` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `upload_type` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '1=inventory,2=menu',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `businesses` (`id`, `image`, `email`, `password`, `otp`, `is_email_verified`, `business_name`, `location`, `business_type`, `description`, `business_days`, `business_from_hours`, `business_to_hours`, `upload_type`, `created_at`, `updated_at`, `lat`, `lng`) VALUES
(1, 'business/business1595312418-87275.jpeg', 'testingdeaninfo@gmail.com', '$2y$10$G6SHYdOKBzwTrh5SdhcWIOY/acYqOVqDQ1sy2x/RbKpFBrm3AFbly', '25273', '1', 'Vikas Gusain', 'New Delhi', 'don\'t know', 'Testing description', '\"[\\\"M\\\",\\\"T\\\"]\"', '10:00', '20:00', '1', '2020-06-29 01:32:34', '2020-07-21 00:50:18', '12.3254300', '45.5646000'),
(7, 'business/business1595312418-87275.jpeg', 'info@gmail.com', '$2y$10$G6SHYdOKBzwTrh5SdhcWIOY/acYqOVqDQ1sy2x/RbKpFBrm3AFbly', '25273', '1', 'ABC', 'New Delhi', 'don\'t know', 'Testing description', '\"[\\\"M\\\",\\\"T\\\"]\"', '10:00', '20:00', '1', '2020-06-29 01:32:34', '2020-07-21 00:50:18', '12.3254300', '45.5646000'),
(8, 'business/business1595312418-87275.jpeg', 'd@gmail.com', '$2y$10$G6SHYdOKBzwTrh5SdhcWIOY/acYqOVqDQ1sy2x/RbKpFBrm3AFbly', '25273', '1', 'Dd', 'fbd', 'don\'t know', 'any', '\"[\\\"M\\\",\\\"T\\\"]\"', '10:00', '20:00', '1', '2020-06-29 01:32:34', '2020-07-24 12:15:05', '12.3254300', '45.5646000'),
(9, NULL, 'h@gmail.com', '1234', NULL, NULL, 'Dd', 'dom', NULL, 'any', NULL, NULL, NULL, NULL, '2020-07-24 18:52:23', '2020-07-24 18:52:23', NULL, NULL),
(12, NULL, 'e@gmail.com', '$2y$10$X.IXDySkxgT8RUTI6aQgredE14pmh0zWAaB7eq8ce5zUENr/OeQIa', NULL, NULL, 'Dd', 'fbd', NULL, 'any', NULL, NULL, NULL, NULL, '2020-07-24 19:09:02', '2020-07-24 19:09:02', NULL, NULL),
(20, NULL, 'zyz@gmail.com', '$2y$10$fwbdclTUIUG4AzJTM4g21.PTZjTZNj8AOEcmrWl851Mh7vPsjBdOK', NULL, NULL, 'Dd', 'doo', NULL, 'anyhhh', NULL, NULL, NULL, NULL, '2020-07-24 21:12:07', '2020-07-25 05:22:54', NULL, NULL);
...
CREATE TABLE `coupons` (
  ...
  `coupon_types` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `link_to_go` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `total_views` int(11) DEFAULT NULL,
  `views_today` int(11) DEFAULT NULL,
  `clicks` int(11) DEFAULT 0,
  `related` tinyint(1) NOT NULL DEFAULT 2 COMMENT '1=>Enable, 2=>Disable',
  ...
  `page_keyword` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `coupons_guides`
--

CREATE TABLE `coupons_guides` (
  `id` int(10) UNSIGNED NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `coupons_guides`
--

INSERT INTO `coupons_guides` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES
(1, 'Step One', '<p>Click on the desired coupon where it says &quot;Show Code&quot;</p>', '2019-06-12 12:44:48', '2019-10-01 00:16:48'),
(2, 'Step Two', '<p>Click Copy and shop from the new window.</p>', '2019-06-12 13:46:41', '2019-10-14 13:48:42'),
(3, 'Step Three', '<p>Paste your coupon at the checkout where it says &quot;discount code&quot; or &quot;coupon code&quot;. This area is typically located in your cart or checkout where you enter credit card info.</p>', '2019-06-12 13:46:48', '2019-10-01 00:17:35');

-- --------------------------------------------------------

--
-- Table structure for table `coupons_video_guides`
--

CREATE TABLE `coupons_video_guides` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `coupons_video_guides`
--

INSERT INTO `coupons_video_guides` (`id`, `video_link`, `created_at`, `updated_at`) VALUES
(1, 'https://www.youtube.com/embed/tgbNymZ7vqY', '2019-06-21 17:38:23', '2019-06-21 12:08:23'),
(3, 'https://www.youtube.com/embed/auUxD3Qe3FU', '2019-07-04 04:36:18', '2019-07-03 23:10:28');
...
CREATE TABLE `coupon_types` (
  ...
  `visible_status` int(11) NOT NULL DEFAULT 1 COMMENT '1=> Enable, 2=>Disable',
  `page_title` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `page_keyword` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `page_description` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `coupon_types` (`id`, `title`, `slug`, `categories`, `description`, `thumbnail`, `main_image`, `featured_image`, `visible_status`, `page_title`, `page_keyword`, `page_description`, `created_at`, `updated_at`) VALUES
(2, 'Discount Coupon', 'discount-coupon', '', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, '2019-06-13 17:36:36', '2019-06-13 12:06:36'),
(3, 'Coupon Code', 'coupon-code', '', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, '2019-06-13 17:56:17', '2019-06-13 12:26:17'),
(5, 'promotion', 'promotion', '', NULL, 'assets/uploads/coupons/types/test-slug-33708.png', 'assets/uploads/coupons/types/test-slug-66762.png', 'assets/uploads/coupons/types/test-slug-25686.jpg', 1, NULL, NULL, NULL, '2019-07-04 13:52:12', '2019-10-02 07:55:28');
...
CREATE TABLE `faqs` (
  ...
  `visibility` int(11) NOT NULL COMMENT '1=>Enable, 2=>Disable',
  `created_at` datetime DEFAULT NULL,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
...
(2, '2019_05_29_090220_create_blog_tags_table', 1),
(5, '2019_06_07_012656_create_delivery_settings_table', 4),
(6, '2019_06_11_171018_create_stores_table', 5),
(7, '2019_06_11_172002_create_coupons_table', 5),
(8, '2019_06_11_182626_create_store_reviews_table', 6),
(9, '2019_06_12_121555_create_coupons_guides_table', 7),
(10, '2019_06_12_190035_create_demo_table', 8),
(11, '2019_06_17_102351_create_store_galleries_table', 9),
(12, '2019_06_21_172959_create_coupons_video_guides_table', 10);
...
CREATE TABLE `notifications` (
  ...
  `color` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Background Color',
  `visible` int(11) DEFAULT NULL COMMENT '1=>Enable, 2=>Disable',
...
INSERT INTO `notifications` (`id`, `content`, `color`, `visible`, `created_at`, `updated_at`) VALUES
(1, NULL, NULL, 2, '2020-01-02 06:45:43', '2020-01-02 06:45:43');
...
CREATE TABLE `pages` (
  ...
  `show_in_menu` int(11) NOT NULL DEFAULT 2 COMMENT '1 => Enable, 2 => Disable',
  `footer_menu` int(11) NOT NULL DEFAULT 2 COMMENT '1 => Enable, 2 => Disable',
  `sequence` int(11) DEFAULT NULL,
  `page_title` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `page_keyword` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `page_description` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `header_image` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `map` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `pages` (`id`, `title`, `slug`, `description`, `show_in_menu`, `footer_menu`, `sequence`, `page_title`, `page_keyword`, `page_description`, `header_image`, `map`, `created_at`, `updated_at`) VALUES
(1, 'any title', 'any-title', '<p>description</p>', 1, 2, -1, 'meta', 'keyword', 'description', '', NULL, '2020-07-24 22:50:42', '2020-07-24 17:20:42');
...
CREATE TABLE `settings` (
  ...
  `tagline` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `website` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `quickbook_application_login` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `quickbook_connection_ticket` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `smtp_driver` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `smtp_username` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `smtp_password` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `smtp_encryption` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `page_title` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `page_keyword` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `page_description` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `google_verification` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `settings` (`id`, `site_title`, `short_title`, `tagline`, `website`, `logo`, `favicon`, `mailchimp_api_key`, `mailchimp_list_id`, `quickbook_application_login`, `quickbook_connection_ticket`, `paypal_email`, `from_name`, `from_email`, `smtp_host`, `smtp_port`, `smtp_driver`, `smtp_username`, `smtp_password`, `smtp_encryption`, `page_title`, `page_keyword`, `page_description`, `google_verification`, `created_at`, `updated_at`) VALUES
(1, 'Queinn', 'QI', NULL, NULL, 'assets/uploads/logo/logo.png', 'assets/uploads/logo/favicon.jpg', NULL, NULL, NULL, NULL, NULL, 'Queinn', 'testingdeaninfo@gmail.com', 'smtp.gmail.com', '587', 'smtp', 'testingdeaninfo@gmail.com', 'vikas@123', 'tls', NULL, NULL, NULL, NULL, '2018-01-02 09:05:18', '2020-07-22 09:43:08');
...
CREATE TABLE `stores` (
  ...
  `gallery` tinyint(4) DEFAULT NULL COMMENT '1=>Yes, 2=>No',
  `video` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `url` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `featured_store` int(11) NOT NULL DEFAULT 0 COMMENT '1 => Enable, 0 => Disable',
  `rated` tinyint(4) DEFAULT 2 COMMENT '1=>Yes, 2=>No',
  `store_reviewed` tinyint(1) NOT NULL DEFAULT 2 COMMENT '1=>Yes, 2=>No',
  `page_title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `page_keyword` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `page_description` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `store_galleries` (`id`, `store_id`, `gallery_images`, `created_at`, `updated_at`) VALUES
(18, 2, 'assets/uploads/stores/mcdonald-0-1561109225.png', '2019-06-21 09:27:14', '2019-06-21 09:27:14'),
(19, 2, 'assets/uploads/stores/mcdonald-1-1561109234.jpg', '2019-06-21 09:27:23', '2019-06-21 09:27:23'),
(22, 2, 'assets/uploads/stores/mcdonald-2-1561109276.jpg', '2019-06-21 09:28:04', '2019-06-21 09:28:04'),
(23, 10, 'assets/uploads/stores/test-store-0-1562056421.PNG', '2019-07-02 19:03:47', '2019-07-02 19:03:47'),
(30, 12, 'assets/uploads/stores/04-july-store-0-1562225442.jpg', '2019-07-04 18:00:44', '2019-07-04 18:00:44'),
(31, 12, 'assets/uploads/stores/04-july-store-1-1562225444.jpg', '2019-07-04 18:00:46', '2019-07-04 18:00:46'),
(36, 19, 'assets/uploads/stores/tedeyf-0-1569536665.jpg', '2019-09-27 03:54:30', '2019-09-27 03:54:30');
...
CREATE TABLE `store_reviews` (
  ...
  `status` int(11) NOT NULL DEFAULT 2 COMMENT '1=>Disable, 2=>Enable',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `store_reviews` (`id`, `store_id`, `name`, `stars`, `review`, `status`, `created_at`, `updated_at`) VALUES
(1, 8, NULL, 4, NULL, 2, '2019-06-25 10:21:54', '2019-06-25 10:21:54'),
(2, 9, NULL, 3, NULL, 2, '2019-06-25 10:22:01', '2019-06-25 10:22:01'),
(3, 2, NULL, 4, NULL, 2, '2019-06-25 10:22:58', '2019-06-25 10:22:58'),
(4, 9, NULL, 3, NULL, 2, '2019-06-25 10:24:58', '2019-06-25 10:24:58'),
(5, 8, NULL, 2, NULL, 2, '2019-06-25 10:50:35', '2019-06-25 10:50:35'),
(6, 8, NULL, 2, NULL, 2, '2019-06-26 21:39:47', '2019-06-26 21:39:47'),
(7, 2, NULL, 5, NULL, 2, '2019-06-26 21:40:07', '2019-06-26 21:40:07'),
(8, 2, NULL, 4, NULL, 2, '2019-06-26 22:30:37', '2019-06-26 22:30:37'),
(9, 2, NULL, 4, NULL, 2, '2019-06-29 02:37:44', '2019-06-29 02:37:44'),
(10, 8, NULL, 1, NULL, 2, '2019-06-29 02:40:54', '2019-06-29 02:40:54'),
(11, 8, NULL, 3, NULL, 2, '2019-07-01 05:14:06', '2019-07-01 05:14:06'),
(12, 11, NULL, 2, NULL, 2, '2019-07-02 19:11:37', '2019-07-02 19:11:37'),
(13, 14, NULL, 1, NULL, 2, '2019-07-09 17:34:10', '2019-07-09 17:34:10'),
(14, 2, NULL, 3, NULL, 2, '2019-07-09 17:34:45', '2019-07-09 17:34:45'),
(15, 8, NULL, 3, NULL, 2, '2019-07-09 17:48:18', '2019-07-09 17:48:18'),
(16, 11, NULL, 3, NULL, 2, '2019-07-09 18:55:35', '2019-07-09 18:55:35'),
(17, 2, NULL, 3, NULL, 2, '2019-08-06 15:36:32', '2019-08-06 15:36:32'),
(18, 8, NULL, 4, NULL, 2, '2019-09-06 16:08:56', '2019-09-06 16:08:56'),
(19, 17, NULL, 3, NULL, 2, '2019-09-11 16:11:25', '2019-09-11 16:11:25'),
(20, 9, NULL, 5, NULL, 2, '2019-09-24 05:20:47', '2019-09-24 05:20:47'),
(21, 19, NULL, 5, NULL, 2, '2019-09-27 03:52:33', '2019-09-27 03:52:33'),
(22, 17, NULL, 5, NULL, 2, '2019-10-02 07:50:19', '2019-10-02 07:50:19'),
(23, 14, NULL, 5, NULL, 2, '2019-10-02 08:14:51', '2019-10-02 08:14:51'),
(24, 13, NULL, 5, NULL, 2, '2019-10-05 08:58:21', '2019-10-05 08:58:21'),
(25, 12, NULL, 5, NULL, 2, '2019-10-05 10:38:41', '2019-10-05 10:38:41'),
(26, 11, NULL, 5, NULL, 2, '2019-10-05 11:44:07', '2019-10-05 11:44:07'),
(27, 10, NULL, 5, NULL, 2, '2019-10-15 19:54:46', '2019-10-15 19:54:46'),
(28, 11, NULL, 5, NULL, 2, '2019-10-15 20:49:41', '2019-10-15 20:49:41'),
(29, 9, NULL, 5, NULL, 2, '2019-10-15 21:03:52', '2019-10-15 21:03:52'),
(30, 8, NULL, 5, NULL, 2, '2019-10-15 21:12:03', '2019-10-15 21:12:03'),
(31, 20, NULL, 5, NULL, 2, '2019-10-22 19:08:17', '2019-10-22 19:08:17'),
(32, 21, NULL, 5, NULL, 2, '2019-10-22 19:21:44', '2019-10-22 19:21:44'),
(33, 22, NULL, 5, NULL, 2, '2019-10-22 19:27:52', '2019-10-22 19:27:52'),
(34, 23, NULL, 5, NULL, 2, '2019-10-22 19:34:00', '2019-10-22 19:34:00'),
(35, 24, NULL, 5, NULL, 2, '2019-10-22 19:42:23', '2019-10-22 19:42:23'),
(36, 25, NULL, 5, NULL, 2, '2019-10-22 19:54:13', '2019-10-22 19:54:13'),
(37, 26, NULL, 5, NULL, 2, '2019-10-22 19:54:23', '2019-10-22 19:54:23'),
(38, 20, NULL, 4, NULL, 2, '2019-10-22 22:53:39', '2019-10-22 22:53:39'),
(39, 27, NULL, 5, NULL, 2, '2019-10-24 21:00:34', '2019-10-24 21:00:34'),
(40, 28, NULL, 5, NULL, 2, '2019-10-24 21:15:06', '2019-10-24 21:15:06'),
(41, 29, NULL, 5, NULL, 2, '2019-10-24 21:22:25', '2019-10-24 21:22:25'),
(42, 30, NULL, 5, NULL, 2, '2019-10-25 06:06:39', '2019-10-25 06:06:39'),
(43, 31, NULL, 5, NULL, 2, '2019-10-25 06:33:34', '2019-10-25 06:33:34'),
(44, 32, NULL, 5, NULL, 2, '2019-10-25 06:41:44', '2019-10-25 06:41:44'),
(45, 33, NULL, 5, NULL, 2, '2019-10-25 06:48:08', '2019-10-25 06:48:08'),
(46, 34, NULL, 5, NULL, 2, '2019-10-25 06:56:03', '2019-10-25 06:56:03'),
(47, 35, NULL, 5, NULL, 2, '2019-10-25 07:01:03', '2019-10-25 07:01:03'),
(48, 36, NULL, 5, NULL, 2, '2019-11-27 08:16:54', '2019-11-27 08:16:54'),
(49, 38, NULL, 5, NULL, 2, '2019-11-27 17:01:05', '2019-11-27 17:01:05'),
(50, 41, NULL, 5, NULL, 2, '2019-12-03 15:01:40', '2019-12-03 15:01:40'),
(51, 42, NULL, 5, NULL, 2, '2019-12-03 15:06:13', '2019-12-03 15:06:13'),
(52, 44, NULL, 5, NULL, 2, '2019-12-06 20:38:12', '2019-12-06 20:38:12'),
(53, 46, NULL, 5, NULL, 2, '2019-12-12 18:14:27', '2019-12-12 18:14:27'),
(54, 47, NULL, 5, NULL, 2, '2019-12-18 13:25:38', '2019-12-18 13:25:38'),
(55, 45, NULL, 5, NULL, 2, '2019-12-18 13:25:49', '2019-12-18 13:25:49'),
(56, 21, NULL, 5, NULL, 2, '2019-12-27 19:23:40', '2019-12-27 19:23:40'),
(57, 36, NULL, 5, NULL, 2, '2020-01-01 04:10:53', '2020-01-01 04:10:53');
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `otp`, `is_email_verified`, `address`, `profile_image`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Updated', 'testingdeaninfo1@gmail.com', '$2y$10$K4wOiTslXrQ1s4RnfhBsdurK6zNMOZZHCUkLxPyHlHIHRPum/yZkG', '26136', '1', 'dem', 'users/users1594027976-45760.jpeg', NULL, '2020-07-02 00:26:18', '2020-07-25 05:45:01'),
(5, 'demo', 'test@gmail.com', '$2y$10$cyZNV5L1Qo0Dprr9mMMfmuoFK/2TyRmR5EtoNPa6.2w2Ec.77PWdu', NULL, NULL, 'anyy', NULL, NULL, '2020-07-25 05:41:58', '2020-07-25 05:43:31');
...
CREATE TABLE `web_settings` (
  `id` int(11) NOT NULL,
  `head_title` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `support_text` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `contact_detail` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  ...
  `tumblr_url` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `web_settings` (`id`, `head_title`, `support_text`, `contact_detail`, `facebook_url`, `twitter_url`, `youtube_url`, `instagram_url`, `google_plus_url`, `tumblr_url`, `linkedin_url`, `created_at`, `updated_at`) VALUES
(1, '', '', '', 'https://www.facebook.com/', 'https://www.twitter.com/', 'https://www.youtube.com', '', '', '', 'https://www.linkedin.com', '2019-07-05 05:56:42', '2019-07-05 05:56:42');
...
--
-- Indexes for table `coupons_guides`
--
ALTER TABLE `coupons_guides`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `coupons_video_guides`
--
ALTER TABLE `coupons_video_guides`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `coupons_guides`
--
ALTER TABLE `coupons_guides`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `coupons_video_guides`
--
ALTER TABLE `coupons_video_guides`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
